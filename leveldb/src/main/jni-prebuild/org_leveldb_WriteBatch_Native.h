...
#include <jni.h>
/* Header for class org_leveldb_WriteBatch_Native */

#ifndef _Included_org_leveldb_WriteBatch_Native
#define _Included_org_leveldb_WriteBatch_Native
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     org_leveldb_WriteBatch_Native
 * Method:    ncreate
 * Signature: ()J
 */
